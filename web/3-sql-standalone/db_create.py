...
root_queries = [
    ...
    "CREATE TABLE part1_db.basic_table (id SMALLINT NOT NULL, name VARCHAR(40), age INTEGER)",
    "CREATE TABLE part1_db.basic_table_names (id SMALLINT NOT NULL, four_letter_name CHAR(4))",
    "CREATE TABLE part1_db.flag_table (flag CHAR(40))",
    "flush privileges;"
    ]
...
cur.execute("INSERT INTO part1_db.flag_table (flag) VALUES ('b0ctf{you_found_the_flag!}');")

for i, name in enumerate(four_letter_names):
    cur.execute("INSERT INTO part1_db.basic_table_names (id, four_letter_name) VALUES ('" + str(i) + "', '" + name + "');")
    ...
    cur.execute("INSERT INTO part1_db.basic_table (id, name, age) VALUES ('" + str(i) + "', '" + name + "', '" + str(age) + "');")

cur.close()
db.commit()
db.close()

db = MySQLdb.connect(host='localhost', user='root', passwd=root_pass, db='part2_db')
cur = db.cursor()
